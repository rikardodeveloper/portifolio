...
let OrderController = class OrderController {
    constructor(orderService, customerService, productService, orderLogService, orderProductService, productDiscountService, orderStatusService, productSpecialService, emailTemplateService, productImageService) {
     ...
     */
    orderList(limit, offset, orderId, orderStatusId, customerName, totalAmount, dateAdded, pago, count, response) {
    ...
    orderChangeStatus(orderChangeStatus, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const OrderProduct = yield this.orderProductService.find({
            ...
            const productSave = yield this.orderProductService.createData(OrderProduct);
            ...
            if (orderChangeStatus.enviar_email === 'Sim') {
                ...
                const aux = orderChangeStatus.previsao;
                const aux2 = moment_1.default(aux).format('DD/MM/YYYY HH:mm');
                ...
                mail_services_1.MAILService.customerLoginMail(message, orderChangeStatus.cliente_email, emailContent.subject);
            }
...
tslib_1.__decorate([
    ...
    tslib_1.__param(5, routing_controllers_1.QueryParam('totalAmount')),
    tslib_1.__param(6, routing_controllers_1.QueryParam('dateAdded')),
    tslib_1.__param(7, routing_controllers_1.QueryParam('pago')),
    tslib_1.__param(8, routing_controllers_1.QueryParam('count')),
    tslib_1.__param(9, routing_controllers_1.Res()),
